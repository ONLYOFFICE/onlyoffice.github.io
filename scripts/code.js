...
(function(window, undefined) {
	...
	window.Asc.plugin.init = function(data)
	{
		...
		config = {css: "body>a {display: none !important;} body {-khtml-user-select: none; user-select: none; -moz-user-select: none; -webkit-user-select: none;} div>img { pointer-events: none; }"};
