...
CustomAssistant.prototype.getInfoForPopup = function(paraId, rangeId)
{
...
CustomAssistant.prototype.onAccept = async function(paraId, rangeId)
{
...
CustomAssistant.prototype.getAnnotationRangeObj = function(paraId, rangeId)
{
	return {
		"paragraphId" : paraId,
		"rangeId" : rangeId,
