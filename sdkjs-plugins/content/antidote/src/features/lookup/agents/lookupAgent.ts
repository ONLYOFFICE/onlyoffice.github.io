...
// Backs both the "Dictionaries" and "Guides" buttons: a single, read-only, static zone containing
// whatever the user typed into the search box. Antidote's Dictionaries/Guides tools don't perform
// replacements back into the word processor, so `correctIntoWordProcessor`/`allowEdit` are no-ops.
export class LookupAgent extends WordProcessorAgent {
