...
* New (beta): Form fields. An opt-in setting lists the document's native form controls in their own tab — text fields, checkboxes, dropdown lists, combo boxes (free text supported), and date pickers with a real date control. Controls marked "contents cannot be edited" appear locked and are never modified.
