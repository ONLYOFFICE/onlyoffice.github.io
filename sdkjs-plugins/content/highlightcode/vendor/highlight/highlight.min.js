...
},n.inherit(s,{relevance:0})]}}})());hljs.registerLanguage("java",(()=>{"use strict"
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})());hljs.registerLanguage("fortran",(()=>{"use strict";function e(...e){
return e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null;var n
...
},contains:[u]},s,e.QUOTE_STRING_MODE,b,o,l,d,{begin:/\.$/}]}}})());hljs.registerLanguage("nginx",(()=>{"use strict";function e(e){
...
illegal:"[^\\s\\}\\{]"}}})());hljs.registerLanguage("rust",(()=>{"use strict";function e(...e){
...
keyword:"Self",built_in:i}},{className:"punctuation",begin:"->"},n]}}})());hljs.registerLanguage("prolog",(()=>{"use strict";return n=>{const e={
...
contains:g.concat([{begin:/\.$/}])}}})());hljs.registerLanguage("perl",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
...
name:"TypeScript",aliases:["ts","tsx"]}),m}})());hljs.registerLanguage("delphi",(()=>{"use strict";return e=>{
...
begin:"&[0-7]+"},{begin:"%[01]+"}]},s,c,t].concat(a)}}})());hljs.registerLanguage("swift",(()=>{"use strict";function e(e){
...
},...B,..._,...M,I,P,...z,...q,U,V]}}})());hljs.registerLanguage("basic",(()=>{"use strict";return E=>({name:"BASIC",
...
className:"variable.constant"},R,k,{match:/\$[(.]/}]}}})());hljs.registerLanguage("ruby",(()=>{"use strict";function e(e){
return n("(?=",e,")")}function n(...e){return e.map((e=>{
return(n=e)?"string"==typeof n?n:n.source:null;var n})).join("")}return a=>{
const i="([a-zA-Z_]\\w*[!?=]?|[-+~]@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?)",s={
...
contains:[a.SHEBANG({binary:"ruby"})].concat(E).concat(c).concat(_)}}})());hljs.registerLanguage("xml",(()=>{"use strict";function e(e){
...
endsParent:!0}]}]}}})());hljs.registerLanguage("apache",(()=>{"use strict";return e=>{const n={
...
className:{1:"keyword",3:"title.class"}}])}}})());hljs.registerLanguage("accesslog",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
