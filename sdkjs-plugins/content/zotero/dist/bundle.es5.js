...
(function(factory) {
            ...
            value: function parseHtmlFormatting(htmlString) {
                ...
                while (i < htmlString.length) {
                    if (htmlString[i] === "<" && i + 1 < htmlString.length) {
                        var isClosingTag = htmlString[i + 1] === "/";
                        var tagEnd = htmlString.indexOf(">", i);
                        if (tagEnd === -1) {
    ...
    var _citSuffix = new WeakMap;
    var _bibPrefix = new WeakMap;
    var _bibSuffix = new WeakMap;
    var _CitationDocService_brand = new WeakSet;
    var CitationDocService = function() {
        function CitationDocService(citPrefix, citSuffix, bibPrefix, bibSuffix) {
            _classCallCheck(this, CitationDocService);
            _classPrivateMethodInitSpec(this, _CitationDocService_brand);
            _classPrivateFieldInitSpec(this, _citPrefixOld, void 0);
            _classPrivateFieldInitSpec(this, _citPrefix, void 0);
            _classPrivateFieldInitSpec(this, _bibPrefixOld, void 0);
            _classPrivateFieldInitSpec(this, _citSuffix, void 0);
            _classPrivateFieldInitSpec(this, _bibPrefix, void 0);
            _classPrivateFieldInitSpec(this, _bibSuffix, void 0);
            _classPrivateFieldSet2(_citPrefixOld, this, "ZOTERO_CITATION");
            _classPrivateFieldSet2(_bibPrefixOld, this, "ZOTERO_BIBLIOGRAPHY");
            _classPrivateFieldSet2(_citPrefix, this, citPrefix);
            _classPrivateFieldSet2(_citSuffix, this, citSuffix);
            _classPrivateFieldSet2(_bibPrefix, this, bibPrefix);
            _classPrivateFieldSet2(_bibSuffix, this, bibSuffix);
        }
        return _createClass(CitationDocService, [ {
            key: "addBibliography",
            value: function() {
                ...
                function addBibliography(_x, _x2) {
                    return _addBibliography.apply(this, arguments);
                }
                return addBibliography;
            }()
        }, {
            key: "addCitation",
            value: function() {
                var _addCitation = _asyncToGenerator(_regenerator().m(function _callee2(text, value, notesStyle) {
                    var formattingPositions, field, bHasNotes;
                    return _regenerator().w(function(_context2) {
                        while (1) switch (_context2.n) {
                          case 0:
                            formattingPositions = CslHtmlParser.parseHtmlFormatting(text);
                            ...
                            bHasNotes = !!(notesStyle && [ "footnotes", "endnotes" ].indexOf(notesStyle) !== -1);
                            if (!bHasNotes) {
                                _context2.n = 1;
                                break;
                            }
                          ...
                          case 2:
                            ...
                            return _context2.a(2, bHasNotes);
                ...
                function addCitation(_x3, _x4, _x5) {
            ...
            value: function getAddinZoteroFields() {
                var self = this;
                return new Promise(function(resolve, reject) {
                    _assertClassBrand(_CitationDocService_brand, self, _getAllAddinFields).call(self).then(function(arrFields) {
                        try {
                            if (arrFields.length) {
                                arrFields = arrFields.filter(function(field) {
                                    return field.Value.indexOf(_classPrivateFieldGet2(_citPrefix, self)) !== -1 || field.Value.indexOf(_classPrivateFieldGet2(_bibPrefix, self)) !== -1 || field.Value.indexOf(_classPrivateFieldGet2(_citPrefixOld, self)) !== -1 || field.Value.indexOf(_classPrivateFieldGet2(_bibPrefixOld, self)) !== -1;
                                });
                            }
                        } catch (e) {
                            reject(e);
            ...
            value: function() {
                ...
                function updateAddinFields(_x6) {
            ...
            value: function() {
                var _convertNotesToText = _asyncToGenerator(_regenerator().m(function _callee4(fields) {
                    ...
                    return _regenerator().w(function(_context4) {
                        while (1) switch (_context4.n) {
                          ...
                          case 5:
                            isReferenceSelected = _context4.v;
                ...
                function convertNotesToText(_x7) {
            ...
            value: function() {
                var _convertTextToNotes = _asyncToGenerator(_regenerator().m(function _callee5(fields, notesStyle) {
                    var formats, i, field, selectFieldResult, formatting;
                ...
                function convertTextToNotes(_x8, _x9) {
            ...
            value: function() {
                var _convertNotesStyle = _asyncToGenerator(_regenerator().m(function _callee6(fields, notesStyle) {
                    var editedFields, formats, i, field, selectFieldResult, isReferenceSelected, formatting;
                    return _regenerator().w(function(_context6) {
                        while (1) switch (_context6.n) {
                          ...
                          case 6:
                            isReferenceSelected = _context6.v;
                            if (isReferenceSelected) {
                                _context6.n = 7;
                                break;
                            }
                ...
                function convertNotesStyle(_x0, _x1) {
                    return _convertNotesStyle.apply(this, arguments);
                }
                return convertNotesStyle;
            }()
        }, {
            key: "moveCursorToField",
            value: function() {
                var _moveCursorToField = _asyncToGenerator(_regenerator().m(function _callee7(fieldId, isBegin) {
                    return _regenerator().w(function(_context7) {
                        while (1) switch (_context7.n) {
                          case 0:
                            return _context7.a(2, new Promise(function(resolve) {
                                isBegin = isBegin !== null && isBegin !== void 0 ? isBegin : true;
                                window.Asc.plugin.executeMethod("MoveCursorToField", [ fieldId, isBegin ], resolve);
                            }));
                        }
                    }, _callee7);
                }));
                function moveCursorToField(_x10, _x11) {
                    return _moveCursorToField.apply(this, arguments);
                }
                return moveCursorToField;
            }()
        }, {
            key: "moveCursorOutsideField",
            value: function() {
                var _moveCursorOutsideField = _asyncToGenerator(_regenerator().m(function _callee8(fieldId, isBeforeField) {
                    return _regenerator().w(function(_context8) {
                        while (1) switch (_context8.n) {
                          case 0:
                            return _context8.a(2, new Promise(function(resolve) {
                                isBeforeField = isBeforeField !== null && isBeforeField !== void 0 ? isBeforeField : false;
                                window.Asc.plugin.executeMethod("MoveCursorOutsideField", [ fieldId, isBeforeField ], resolve);
                            }));
                        }
                    }, _callee8);
                }));
                function moveCursorOutsideField(_x12, _x13) {
                    return _moveCursorOutsideField.apply(this, arguments);
                }
                return moveCursorOutsideField;
            }()
        }, {
            key: "moveCursorRight",
            value: function() {
                var _moveCursorRight = _asyncToGenerator(_regenerator().m(function _callee9() {
                ...
                function moveCursorRight() {
                    return _moveCursorRight.apply(this, arguments);
                }
    ...
    function _removeSelectedContent() {
        return new Promise(function(resolve) {
            window.Asc.plugin.executeMethod("RemoveSelectedContent", undefined, resolve);
        });
    }
    function _selectField(fieldId) {
        return new Promise(function(resolve) {
            window.Asc.plugin.executeMethod("SelectAddinField", [ fieldId ], function() {
                return resolve(true);
            });
        });
    }
    ...
    function _pasteBibliographyWithHtml(_x14, _x15) {
        return _pasteBibliographyWithHtml2.apply(this, arguments);
    }
    function _pasteBibliographyWithHtml2() {
        _pasteBibliographyWithHtml2 = _asyncToGenerator(_regenerator().m(function _callee0(field, html) {
            ...
            return _regenerator().w(function(_context0) {
                while (1) switch (_context0.n) {
                  ...
                  case 3:
                    ...
                    numbers = new Array(paragraphs.length);
                    paragraphs.forEach(function(p, index) {
                        var margin = p.querySelector(".csl-left-margin");
                        var right = p.querySelector(".csl-right-inline");
                        right === null || right === void 0 || right.replaceWith.apply(right, _toConsumableArray(right.childNodes));
                        if (margin) {
                  ...
                  case 8:
                    ...
                    return _context0.a(2, addedField.FieldId);
                }
            }, _callee0, this);
        }));
        return _pasteBibliographyWithHtml2.apply(this, arguments);
    ...
    var CSLCitationStorage = function() {
        ...
        return _createClass(CSLCitationStorage, [ {
            ...
            key: "getAllCitationsInJson",
            value: function getAllCitationsInJson() {
                return _classPrivateFieldGet2(_citations, this).map(function(citation) {
    ...
    var CSLCitation = function() {
        function CSLCitation(citationID) {
            _classCallCheck(this, CSLCitation);
        ...
        return _createClass(CSLCitation, [ {
            key: "fillFromObject",
            value: function fillFromObject(citationObject) {
            ...
            key: "getCitationItems",
            value: function getCitationItems() {
                return this._citationItems;
            }
        }, {
            key: "getDoNotUpdate",
            value: function getDoNotUpdate() {
            ...
            key: "getInfoForCitationCluster",
            value: function getInfoForCitationCluster() {
                return this._citationItems.map(function(item) {
                    return item.getInfoForCitationCluster();
                }, this);
            }
        }, {
            key: "getPlainCitation",
            value: function getPlainCitation() {
            ...
            key: "setNoteIndex",
            value: function setNoteIndex(noteIndex) {
                _assertClassBrand(_CSLCitation_brand, this, _setProperties).call(this, {
                    noteIndex: noteIndex
                });
                return this;
            ...
            key: "setPlainCitation",
            value: function setPlainCitation(plainCitation) {
                _assertClassBrand(_CSLCitation_brand, this, _setProperties).call(this, {
            ...
            key: "setManualOverride",
            value: function setManualOverride(citeprocText, manualOverrideText) {
                var manualOverride = {
    ...
    var AdditionalWindow = function() {
        ...
        return _createClass(AdditionalWindow, [ {
            ...
            key: "showEditWindow",
            value: function showEditWindow(content) {
                var _this2 = this;
                _classPrivateFieldSet2(_window, this, new window.Asc.PluginWindow);
                var variation = {
                    name: "Zotero",
                ...
                return new Promise(function(resolve, reject) {
                    window.Asc.plugin.button = function() {
                        var _ref = _asyncToGenerator(_regenerator().m(function _callee(buttonId, windowId) {
                            var element;
                            return _regenerator().w(function(_context) {
                                while (1) switch (_context.n) {
                                  case 0:
            ...
            value: function showInfoWindow(description, text, type) {
                ...
                return new Promise(function(resolve, reject) {
                    window.Asc.plugin.button = function(buttonId, windowId) {
                        ...
                        _assertClassBrand(_AdditionalWindow_brand, _this3, _hide).call(_this3);
                    };
                });
            }
        }, {
    ...
    var CitationService = function() {
        ...
        return _createClass(CitationService, [ {
            key: "getCurrentField",
            value: function() {
                var _getCurrentField = _asyncToGenerator(_regenerator().m(function _callee() {
                    return _regenerator().w(function(_context) {
                        while (1) switch (_context.n) {
                          case 0:
                            return _context.a(2, this.citationDocService.getCurrentField());
                        }
                    }, _callee, this);
                }));
            ...
            key: "saveAsText",
            value: function() {
                var _saveAsText = _asyncToGenerator(_regenerator().m(function _callee2() {
                    var isOk;
                    return _regenerator().w(function(_context2) {
                        while (1) switch (_context2.n) {
                          case 0:
            ...
            value: function() {
                var _insertSelectedCitations = _asyncToGenerator(_regenerator().m(function _callee3(items) {
                    var _this = this;
                    ...
                    return _regenerator().w(function(_context3) {
                        while (1) switch (_context3.p = _context3.n) {
                          ...
                          case 4:
                            ...
                            return _context3.a(2, _assertClassBrand(_CitationService_brand, this, _getSelectedInJsonFormat).call(this, items).then(function(items) {
                ...
                return insertSelectedCitations;
            }()
        }, {
            key: "insertBibliography",
            value: function() {
                var _insertBibliography = _asyncToGenerator(_regenerator().m(function _callee4() {
                    ...
                    return _regenerator().w(function(_context4) {
                        while (1) switch (_context4.p = _context4.n) {
                          ...
                          case 1:
                            _yield$_assertClassBr = _context4.v;
            ...
            key: "moveCursorToField",
            value: function() {
                var _moveCursorToField = _asyncToGenerator(_regenerator().m(function _callee5(fieldId, isBegin) {
                    return _regenerator().w(function(_context5) {
                        while (1) switch (_context5.n) {
                          case 0:
                            return _context5.a(2, this.citationDocService.moveCursorToField(fieldId, isBegin));
                        }
                    }, _callee5, this);
                }));
                function moveCursorToField(_x2, _x3) {
                    return _moveCursorToField.apply(this, arguments);
                }
                return moveCursorToField;
            }()
            ...
            key: "moveCursorOutsideField",
            value: function() {
                var _moveCursorOutsideField = _asyncToGenerator(_regenerator().m(function _callee6(fieldId, isBeforeField) {
                    return _regenerator().w(function(_context6) {
                        while (1) switch (_context6.n) {
                          case 0:
                            return _context6.a(2, this.citationDocService.moveCursorOutsideField(fieldId, isBeforeField));
                        }
                    }, _callee6, this);
                }));
                function moveCursorOutsideField(_x4, _x5) {
                    return _moveCursorOutsideField.apply(this, arguments);
                }
                return moveCursorOutsideField;
            }()
            ...
            key: "moveCursorRight",
            value: function() {
                var _moveCursorRight = _asyncToGenerator(_regenerator().m(function _callee7() {
                    return _regenerator().w(function(_context7) {
                        while (1) switch (_context7.n) {
                          case 0:
                            return _context7.a(2, this.citationDocService.moveCursorRight());
                        }
                    }, _callee7, this);
                }));
                function moveCursorRight() {
            ...
            key: "updateCslItems",
            value: function() {
                var _updateCslItems = _asyncToGenerator(_regenerator().m(function _callee8(bHardRefresh) {
                    ...
                    return _regenerator().w(function(_context8) {
                        while (1) switch (_context8.p = _context8.n) {
                          ...
                          case 1:
                            _yield$_assertClassBr2 = _context8.v;
                            ...
                            if (typeof bHardRefresh === "undefined") {
                                format = this._cslStylesManager.getLastUsedFormat();
                                if (format === "numeric") {
                                    bHardRefresh = true;
                                }
                            }
                          ...
                          case 5:
                            ...
                            return _context8.a(2, this.citationDocService.updateAddinFields(updatedFields));
            ...
            value: function() {
                var _updateCslItemsInNotes = _asyncToGenerator(_regenerator().m(function _callee9(notesStyle) {
                    ...
                    return _regenerator().w(function(_context9) {
                        while (1) switch (_context9.p = _context9.n) {
                          ...
                          case 1:
                            _yield$_assertClassBr3 = _context9.v;
                ...
                function updateCslItemsInNotes(_x7) {
            ...
            key: "updateItem",
            value: function() {
                var _updateItem = _asyncToGenerator(_regenerator().m(function _callee0(updatedField, notesStyle) {
                    ...
                    return _regenerator().w(function(_context0) {
                        while (1) switch (_context0.p = _context0.n) {
                          ...
                          case 1:
                            _yield$_assertClassBr4 = _context0.v;
                            fieldsWithCitations = _yield$_assertClassBr4.fieldsWithCitations;
                            _yield$_assertClassBr4.bibField;
                          ...
                          case 4:
                            ...
                            return _context0.a(2, this.citationDocService.updateAddinFields(updatedFields));
            ...
            value: function() {
                var _switchingBetweenNotesAndText = _asyncToGenerator(_regenerator().m(function _callee1(notesStyle) {
                    var _yield$_assertClassBr5, fieldsWithCitations, bibField, bNoHaveFields, updatedFields, bibFields, _t9, _t0;
                    return _regenerator().w(function(_context1) {
                        while (1) switch (_context1.p = _context1.n) {
                          ...
                          case 1:
                            _yield$_assertClassBr5 = _context1.v;
                            fieldsWithCitations = _yield$_assertClassBr5.fieldsWithCitations;
                            bibField = _yield$_assertClassBr5.bibField;
                            bNoHaveFields = fieldsWithCitations.length === 0;
                            _assertClassBrand(_CitationService_brand, this, _updateFormatter).call(this);
                            _context1.n = 2;
                            return _assertClassBrand(_CitationService_brand, this, _getUpdatedFields).call(this, fieldsWithCitations, true);
                ...
                function switchingBetweenNotesAndText(_x0) {
            ...
            key: "convertNotesStyle",
            value: function() {
                var _convertNotesStyle = _asyncToGenerator(_regenerator().m(function _callee10(notesStyle) {
                    var _yield$_assertClassBr6, fieldsWithCitations, updatedFields, _t1;
                    return _regenerator().w(function(_context10) {
                        while (1) switch (_context10.p = _context10.n) {
                          ...
                          case 1:
                            _yield$_assertClassBr6 = _context10.v;
                ...
                function convertNotesStyle(_x1) {
                    return _convertNotesStyle.apply(this, arguments);
                }
                return convertNotesStyle;
            }()
            ...
            value: function() {
                var _showEditCitationWindow = _asyncToGenerator(_regenerator().m(function _callee11(field) {
                    var citationObject, updatedField;
                    return _regenerator().w(function(_context11) {
                        while (1) switch (_context11.n) {
                          ...
                          case 1:
                            citationObject = _assertClassBrand(_CitationService_brand, this, _extractField).call(this, field);
                            _context11.n = 2;
                            return _classPrivateFieldGet2(_additionalWindow, this).showEditWindow(citationObject);

                          case 2:
                            updatedField = _context11.v;
                            if (updatedField) {
                                _context11.n = 3;
                                break;
                            }
                          ...
                          case 3:
                            return _context11.a(2, updatedField);
                        }
                    }, _callee11, this);
                }));
                function showEditCitationWindow(_x10) {
    ...
    function _formatInsertLink(cslCitation) {
        ...
        return Promise.resolve().then(function() {
            ...
            var citations = self._storage.getAllCitationsInJson();
            self._formatter.rebuildProcessorState(citations);
            var formattedCitationObj = self._formatter.processCitationCluster(cslCitation.toJSON(), citationsPre, citationsPost);
            var htmlCitation = _assertClassBrand(_CitationService_brand, self, _unEscapeHtml).call(self, formattedCitationObj[1][0][1]);
    ...
    function _getSelectedInJsonFormat(items) {
        ...
        return Promise.all(promises).then(function(res) {
            return res.reduce(function(acc, resItems) {
                return acc.concat(resItems);
            }, []);
        });
    }
    function _makeBibliography() {
        try {
            ...
            for (var i = 0; i < bibObject[1].length; i++) {
                ...
                if (window.Asc.scope.editorVersion < 9004e3) {
                    bibText += "\n";
                }
                bibItems.push(bibText);
            }
            var htmlBibliography = bibItems.join("").trim();
    ...
    function _synchronizeStorageWithDocItems(updatedField) {
        ...
        return this.citationDocService.getAddinZoteroFields().then(function(arrFields) {
            ...
            if (updatedField) {
                fieldsWithCitations = fieldsWithCitations.filter(function(b) {
                    if (b.cslCitation.citationID === updatedField.citationID) {
                        return true;
                    }
                    return false;
                });
    ...
    function _getUpdatedFields(_x11, _x12, _x13) {
        return _getUpdatedFields2.apply(this, arguments);
    }
    function _getUpdatedFields2() {
        _getUpdatedFields2 = _asyncToGenerator(_regenerator().m(function _callee12(fieldsWithCitations, bHardRefresh, bChangePosition) {
            ...
            return _regenerator().w(function(_context12) {
                while (1) switch (_context12.n) {
                  case 0:
                    ...
                    fragment.appendChild(tempElement);
                    updatedFields = [];
                    i = fieldsWithCitations.length - 1;
                  ...
                  case 1:
                    ...
                    citationsPost = this._storage.getCitationsPost(cslCitation.citationID);
                    citations = this._storage.getAllCitationsInJson();
                    this._formatter.rebuildProcessorState(citations);
                    formattedCitationObj = this._formatter.processCitationCluster(cslCitation.toJSON(), citationsPre, citationsPost);
                    htmlCitation = _assertClassBrand(_CitationService_brand, this, _unEscapeHtml).call(this, formattedCitationObj[1][0][1]);
                    tempElement.innerHTML = htmlCitation;
                    oldContentInCit = cslCitation.getPlainCitation();
                    oldContentInDoc = field["Content"];
                    if (oldContentInCit === "") {
                  ...
                  case 2:
                    ...
                    text = "<p>" + translate("You have modified this citation since Zotero generated it. Do you want to keep your modifications and prevent future updates?") + "</p>" + "<p>" + translate("Clicking „Yes“ will prevent Zotero from updating this citation if you add additional citations, switch styles, or modify the item to which it refers. Clicking „No“ will erase your changes.") + "</p>" + "<p>" + translate("Original:") + " " + newContent + "</p>" + "<p>" + translate("Modified:") + " " + oldContentInDoc + "</p>";
                    _context12.n = 3;
                    return _classPrivateFieldGet2(_additionalWindow, this).show("Saving custom edits", text);

                  case 3:
                    bNeedSaveUserInput = _context12.v;
                  ...
                  case 7:
                    return _context12.a(2, updatedFields);
                }
            }, _callee12, this);
        }));
        return _getUpdatedFields2.apply(this, arguments);
    ...
    (function() {
        ...
        window.Asc.plugin.init = function() {
            ...
            loginPage.init().onOpen(function() {
                ...
                isInit = true;
                Loader.show();
                var loadGroupsPromise = loadGroups().catch(function(e) {
                    console.error(e);
        ...
        function showCitationsAtTheStartFromMyLibrary() {
            ...
            return loadLibrary(promise, false).then(function(res) {
                if (res > 0) {
        ...
        function addEventListeners() {
            ...
            insertLinkBtn.subscribe(function() {
                var _ref3 = _asyncToGenerator(_regenerator().m(function _callee4(event) {
                    var items, addedField, bHasNotes;
                    return _regenerator().w(function(_context4) {
                        while (1) switch (_context4.n) {
                          case 0:
                            if (!(event.type !== "button:click")) {
                          ...
                          case 3:
                            _context4.n = 4;
                            return onStartAction(true, "Zotero (" + translate("Inserting citation") + ")");

                          case 4:
                            items = selectCitation.getSelectedItems();
                            addedField = null;
                            bHasNotes = false;
                            return _context4.a(2, citationService.insertSelectedCitations(items).then(function(hasNotes) {
                                bHasNotes = hasNotes;
                                ...
                                showError(message);
                            }).finally(_asyncToGenerator(_regenerator().m(function _callee3() {
                                return _regenerator().w(function(_context3) {
                                    while (1) switch (_context3.n) {
                                      ...
                                      case 2:
                                        ...
                                        _context3.n = 3;
                                        return citationService.moveCursorOutsideField(addedField.FieldId);
            ...
            saveAsTextBtn.subscribe(function() {
                var _ref5 = _asyncToGenerator(_regenerator().m(function _callee5(event) {
                    return _regenerator().w(function(_context5) {
                        while (1) switch (_context5.n) {
                          case 0:
                            if (!(event.type !== "button:click")) {
            ...
            settings.onChangeState(function() {
                var _ref6 = _asyncToGenerator(_regenerator().m(function _callee6(newState, oldState) {
                    var updateFn;
                    return _regenerator().w(function(_context6) {
                        while (1) switch (_context6.n) {
                          case 0:
        ...
        function _onStartAction() {
            _onStartAction = _asyncToGenerator(_regenerator().m(function _callee8(keepSelection, preloaderMessage) {
                return _regenerator().w(function(_context8) {
                    while (1) switch (_context8.n) {
                      case 0:
        ...
        function _onEndAction() {
            _onEndAction = _asyncToGenerator(_regenerator().m(function _callee9(scrollToTarget, preloaderMessage) {
                return _regenerator().w(function(_context9) {
                    while (1) switch (_context9.n) {
                      case 0:
                        insertBibBtn.enable();
        ...
        function _getEditorVersion() {
            _getEditorVersion = _asyncToGenerator(_regenerator().m(function _callee0() {
                ...
                return _regenerator().w(function(_context0) {
                    while (1) switch (_context0.p = _context0.n) {
                      ...
                      case 1:
                        ...
                        return _context0.a(2, 1e6 * parseInt(arrVer[0]) + 1e3 * parseInt(arrVer[1]) + parseInt(arrVer[2]));

                      case 2:
                        _context0.p = 2;
                        _t = _context0.v;
                        console.error(_t);
                        return _context0.a(2, 99999999);
                    }
                }, _callee0, null, [ [ 0, 2 ] ]);
            }));
            return _getEditorVersion.apply(this, arguments);
        ...
        function addContextMenuButtons() {
            ...
            buttonMain.attachOnClick(_asyncToGenerator(_regenerator().m(function _callee7() {
