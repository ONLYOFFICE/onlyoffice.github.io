% onlyoffice-documentserver-plugin-chess(SECTION) | User Commands
%
% "March  1 2023"
...
onlyoffice-documentserver-plugin-chess - program to do something

# SYNOPSIS

**onlyoffice-documentserver-plugin-chess** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**onlyoffice-documentserver-plugin-chess** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **onlyoffice-documentserver-plugin-chess** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**onlyoffice-documentserver-plugin-chess** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    onlyoffice-documentserver-plugin-chess. See **foo.conf**(5) for further details.
...
**onlyoffice-documentserver-plugin-chess** provides some return codes, that can be used in scripts:
...
Elbakyan Shirak <el.shirak@internet.ru>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Elbakyan Shirak
