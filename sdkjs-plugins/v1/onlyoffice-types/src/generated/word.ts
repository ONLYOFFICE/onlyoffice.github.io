...
type ALPHABETIC = any;
type AM = any;
type ApiTableOfContents = any;
type ApiTableOfFigures = any;
type Arabic = any;
type Area = any;
type AreaStacked = any;
type AreaStacked100 = any;
type BarClustered = any;
type BarStacked = any;
type BarStacked100 = any;
type ColumnClustered = any;
type ColumnStacked = any;
type ColumnStacked100 = any;
type Combo = any;
type ComboColumnClusteredLine = any;
type ComboColumnClusteredLineSecondaryAxis = any;
type Doughnut = any;
type Equation = any;
type Figure = any;
type General = any;
type Line = any;
type LineMarkers = any;
type LineMarkersStacked = any;
type LineMarkersStacked100 = any;
type LineStacked = any;
type LineStacked100 = any;
type PM = any;
type ParaAdd = any;
type ParaPr = any;
type ParaRem = any;
type Pie = any;
type Radar = any;
type RadarFilled = any;
type RadarMarkers = any;
type Red = any;
type Roman = any;
type StockHLC = any;
type StockOHLC = any;
...
type Unknown = any;
type XYScatter = any;
type XYScatterLines = any;
type XYScatterLinesNoMarkers = any;
type XYScatterSmooth = any;
type XYScatterSmoothNoMarkers = any;
