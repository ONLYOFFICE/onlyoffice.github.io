	...
	switch (message.type) {
		...
		case 'Theme':
			...
			if (themeType.includes('light')) {
				...
				rule += 'select2-container--default .select2-results__option--highlighted[aria-selected] { color: white !important;}\n'
				message.style.replace('.select2-container--default .select2-results__option--highlighted[aria-selected] {background-color : #555 !important; }\n','');
			}
