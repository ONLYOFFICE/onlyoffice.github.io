					...
					'<div class="div_footer">' +
						'<div class="advanced_info">' +
							(plugin.rating
								...
								: '<div class="flex div_rating_card"> <div class="div_rating"> <img class="stars_grey" src="./resources/img/stars/rating-stars.svg"/> <img class="stars_orange" style="width:0;" src="./resources/img/stars/rating-stars-colored.svg"/> </div> <span style="margin-left: 5px;"></span> </div>'
							) +
							(bHasUpdate
