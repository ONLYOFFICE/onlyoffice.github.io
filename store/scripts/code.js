					...
					'<div class="div_footer">' +
						'<div class="advanced_info">' +
							(plugin.rating
								...
								: '<div class="flex div_rating_card"> <div class="div_rating"> <img class="stars_grey" src="./resources/img/stars/rating-stars.svg"/> <div><img class="stars_orange" style="width:100%; height:100%;" src="./resources/img/stars/rating-stars-colored.svg"/> </div> </div> <span style="margin-left: 5px;"></span> </div>'
							) +
							(bHasUpdate
