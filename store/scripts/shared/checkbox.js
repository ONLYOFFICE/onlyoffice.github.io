...
Checkbox.prototype = {
    ...
    _updateVisualState: function () {
        ...
        if (this._options.checked) {
            this._container.classList.add("checkbox--checked")
        } else {
            this._container.classList.remove("checkbox--checked")
        }

        if (this._options.indeterminate) {
            this._container.classList.add("checkbox--indeterminate");
        } else {
            this._container.classList.remove("checkbox--indeterminate");
        }
    ...
    destroy: function () {
        ...
        this._handlers.forEach(function(handler, event) {
            self._container &&
                self._container.removeEventListener(event, handler);
        });
